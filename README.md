![Shahid Shaikh Introduction](https://github.com/shaikh-shahid/shaikh-shahid/blob/master/Shahid%20shaikh.jpg)
...
I’m a Principal Software Architect, Blockchain & Distributed Systems developer, and technical author. I write technical content to share what I’ve learned throughout my career and to help others build better software. 🚀

---

## About

- 💼 Currently working as a **Principal Software Architect** at [Accionlabs](https://www.accionlabs.com/).  
- ✍️ I write detailed technical articles on my blog: [shaikhshahid.com](https://shaikhshahid.com/).  
- 🔬 My interests: distributed systems, blockchain, low-latency databases, systems programming, and developer experience.

---

## Skills

- Languages: Go, Rust, Node.js (JavaScript/TypeScript)  
- Systems: Distributed systems, P2P, Blockchain design, Consensus, KV stores  
- Databases & storage: Redis-compatible systems, various SQL/NoSQL engines  
- Other: API design, observability, developer tooling, technical writing
...
- [Sweet LSTAT](https://github.com/shaikh-shahid/sweet-lstat) — More descriptive lstat messages 🛠️  
...
- Website / Blog: [shaikhshahid.com](https://shaikhshahid.com/) 🌐  
- GitHub: [shaikh-shahid](https://github.com/shaikh-shahid) 🐙  
- X: [@shaikh-shahid](https://x.com/shahidontech) 🐦  
- LinkedIn: [https://www.linkedin.com/in/skshahid](https://www.linkedin.com/in/skshahid)) 💼
- Email: hello@shaikhshahid.com ✉️  
